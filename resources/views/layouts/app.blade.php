                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" id="p_requisito" href="#">Requisito</a>
                            <a class="dropdown-item" id="p_sistema" href="#">Sistema</a>
                            <a class="dropdown-item" id="p_tratamento" href="#">Tratamento</a>
                            <a class="dropdown-item" id="p_usuario"  href="{{ route('register') }}">Usuário</a>
                            <a class="dropdown-item" id="p_versao" href="#">Versão</a>
                        </div>
                    </li>
