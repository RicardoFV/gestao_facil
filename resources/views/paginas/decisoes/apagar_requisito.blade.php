...
<div class="container">
    <div class="card mt-1">
        ...
        <div class="card-body">
            ...
            <h1 class="text-center">Tem certeza que deseja remover esse Requisito  ?</h1>
            ...
            <div class="form-row col-sm-12 justify-content-center">
                <div class="form-group col-sm-6 d-flex inline mt-3 justify-content-sm-end">
                    ...
                    <form method="post" action="{{route('requisitos.destroy',$requisito->id )}}">
                            @csrf
                ...
                <div class="form-group col-sm-6 d-flex inline mt-3 justify-content-sm-start">
                    <a href="{{route('requisitos.index')}}" class="btn btn-primary btn-sm">Não</a>
                </div>
            </div>
