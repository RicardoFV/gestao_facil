...
<div class="container">
    <div class="card mt-1">
        ...
        <div class="form-row col-sm-12 justify-content-center">
            <div class="form-group col-sm-4 d-flex inline mt-3">
                <a href="{{ route('vinculos.index') }}" class="btn btn-block btn-primary">Voltar</a>
            </div>
            <div class="form-group col-sm-4 d-flex inline mt-3 mr-5">
            ...
            <table class="table table-hover table-sm">
                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($empresa->id_gestor == Auth::user()->id ||
                            Auth::user()->perfil_acesso == 'super_admin'||
                            $empresa->id_usuario_responsavel == Auth::user()->id )
